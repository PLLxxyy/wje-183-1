...
import { type TaxResult, type DeductionInput, getOptimizationTips, MONTHLY_THRESHOLD } from '../utils/tax'
...
export default function Result() {
  ...
  const { result, deductions, monthlyIncome, city } = state;
  const tips = useMemo(() => getOptimizationTips(monthlyIncome, deductions, result), [monthlyIncome, deductions, result]);
  ...
  return (
    <div className="page-container fade-in">
      ...
      <div className="result-hero">
        <div className="result-hero-label">{view === 'monthly' ? '每月到手收入' : '每年到手收入'}</div>
        <div className="result-hero-amount">{fmt(result.netMonthly)} 元</div>
